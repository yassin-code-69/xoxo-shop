          ...
          <Link href="/" className="flex items-center gap-2 select-none">
            <div className="flex items-center font-bold text-2xl tracking-tighter">
              <div className="flex relative items-center">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border-4 border-black dark:border-white mr-1 relative flex items-center justify-center transition-colors">
                  <div className="w-2 sm:w-2.5 h-2 sm:h-2.5 bg-black dark:bg-white rounded-full mb-2.5 sm:mb-3 ml-1.5 sm:ml-2 transition-colors"></div>
                  <div className="absolute -top-1 -right-1 w-2 h-2 bg-purple-600 rounded-full"></div>
                </div>
                <div className="flex flex-col leading-none">
                  <span className="text-black dark:text-white font-black text-[16px] sm:text-[18px] transition-colors">
                    XoXo
                  </span>
                  <span className="text-purple-600 font-black text-[12px] sm:text-[14px]">
                    Shop
                  </span>
                </div>
              </div>
