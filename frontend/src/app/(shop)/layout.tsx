...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${inter.variable} antialiased bg-[#f4f6fb] dark:bg-slate-900 text-slate-800 dark:text-slate-100 min-h-screen flex flex-col font-sans transition-colors duration-300`}>
          ...
          <header className="bg-white dark:bg-slate-950 sticky top-0 z-50 shadow-sm border-b border-slate-100 dark:border-slate-800 transition-colors duration-300">
            <div className="container mx-auto px-4 max-w-6xl h-20 flex items-center justify-between">
                ...
                <div className="flex items-center font-bold text-2xl tracking-tighter">
                  <div className="flex relative items-center">
                    ...
                    <div className="flex flex-col leading-none">
                      <span className="text-black dark:text-white font-black text-[18px] transition-colors">XoXo</span>
              ...
              <nav className="hidden md:flex items-center gap-8">
                <Link href="/" className="text-sm font-bold text-slate-700 dark:text-slate-300 hover:text-[#6b46c1] dark:hover:text-[#9f7aea] transition-colors flex items-center gap-2">
                  <Home size={16} /> Home
                </Link>
                <Link href="/" className="text-sm font-bold text-slate-700 dark:text-slate-300 hover:text-[#6b46c1] dark:hover:text-[#9f7aea] transition-colors flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                <div className="hidden md:flex relative mr-2">
                  ...
                  <input type="text" placeholder="Search..." className="pl-9 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-[#6b46c1] dark:text-white transition-all w-48" />
                </div>
                <ThemeToggle />
