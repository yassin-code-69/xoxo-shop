...
export default function RegisterPage() {
  ...
  const { loginWithGoogle, loginWithMock, registerWithSupabase, isSupabaseEnabled } = useAuth();
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      const msg = err instanceof Error ? err.message : "Failed to register with Google.";
      setError(msg);
